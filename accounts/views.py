...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # user.is_active = True
            user.save()
            #the previous one was bad because it was saving the user before creating the profile, and the profile needs the user id to be created, so we need to create the profile after saving the user
